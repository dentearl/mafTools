...
objs = jkmaf.o genome.o mafTree.o malnComp.o malnBlk.o malnBlkCursor.o malnSet.o malnJoinBlks.o malnJoinDups.o malnJoinSets.o malnDeleteBlks.o malnMultiParents.o malnCompCompMap.o mafJoin.o
cflags += -I ${kentInc}
